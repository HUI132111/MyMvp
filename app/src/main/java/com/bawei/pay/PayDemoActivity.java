...
import com.bwie.aizhonghui.mymvp.Zf_SuccessActivity;
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        Intent in=new Intent(PayDemoActivity.this, Zf_SuccessActivity.class);
                        if(uid!=null&&orderld!=null){
                            in.putExtra("uid",uid);
                            in.putExtra("orderld",orderld);
                            System.out.println("sfsfsdfsdfdfsfsdfsdfsfds");
                            PayDemoActivity.this.startActivity(in);
                        }
